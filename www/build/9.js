...
var SlideNestedPage = /** @class */ (function () {
    ...
    SlideNestedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-slide-nested',template:/*ion-inline-start:"C:\Users\mroberts\Documents\Ionic\AzorApp\src\pages\slide\slide-nested\slide-nested.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>Nested Slides</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-slides #slider pager>\n    <ion-slide *ngFor="let slide of slides"\n               [ngStyle]="{\'background\' : \'url(\' + slide.imageUrl + \')\'}">\n      <h2>{{slide.title}}</h2>\n    </ion-slide>\n    <ion-slides pager direction="vertical">\n      <ion-slide *ngFor="let slide of slides"\n                  [ngStyle]="{\'background\' : \'url(\' + slide.imageUrl + \')\'}">\n        <h2>{{slide.title}}</h2>\n      </ion-slide>\n    </ion-slides>\n  </ion-slides>\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\mroberts\Documents\Ionic\AzorApp\src\pages\slide\slide-nested\slide-nested.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__slide_nested__ = __webpack_require__(1265);
